...
import { EventsHeaderBar } from '@/events/components/EventsHeaderBar';
import EventDetailsPage from "./EventDetailsPage";
import CreateEventScreen from "./CreateEvent";
import PlansScreen from "@/payments/screens/PlansScreen";
...
import UserPreferencesScreen from "@/profile/screens/UserPreferencesScreen";
import SubscriptionScreen from "@/payments/screens/SubscriptionScreen";
import AboutScreen from "@/shared/screens/AboutScreen";
import PrivacyScreen from "@/shared/screens/PrivacyScreen";
...
import InvoicesScreen from "@/payments/screens/InvoicesScreen";
import MyJoinRequestsScreen from "./MyJoinRequestsScreen";
import { apiClient } from "@/services/apiClient";
import {  FilterBottomSheet,  Segmented } from "@/ui";
import { gradients } from "@/theme";
import { EventsFilters } from "@/events/components/EventsFilters";
import { TabContent as FeatureTabContent } from "@/events/components/TabContent";
...
async function fetchEvents(q: EventsQuery & { nearby?: { lat: number; lon: number; radius_km?: number } | null }): Promise<{ items: EventItem[]; hasMore: boolean; points: Array<{ id: string; lat: number; lon: number; title?: string }> }> {
  ...
  if (q.status) {
    ...
    // For drafts and deleted, always show only user's own events
