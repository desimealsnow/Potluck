...
import { View, Text, TextInput, TouchableOpacity, ScrollView, Platform, Modal, ActivityIndicator } from 'react-native';
import { apiClient, ItemCatalog, UserItem } from '@/services/apiClient';
import { Icon } from '@/ui/Icon';
import { styles } from '../styles/ItemLibrarySheetStyle';
