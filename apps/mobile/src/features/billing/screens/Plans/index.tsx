  ...
  return (
    <View style={{ flex: 1, backgroundColor: '#351657' }}>
      <SafeAreaView style={{ flex: 1 }}>
        ...
        >
          <Segmented
            options={[{ key: "monthly", label: "Monthly" }, { key: "yearly", label: "Yearly" }]}
            value={cycle}
          ...
          <View style={styles.promoCard}>
            ...
            <View style={styles.promoRow}>
              <TextInput value={promo} onChangeText={setPromo} placeholder="Enter code" placeholderTextColor="rgba(0,0,0,0.35)" style={styles.promoInput} />
              <Pressable onPress={applyPromo} style={styles.applyBtn}>
                <Text style={{ color: "#111", fontWeight: "900" }}>Apply</Text>
              </Pressable>
            </View>
            <Text style={styles.finePrint}>
              By subscribing, you agree to our Terms of Service and Privacy Policy. Subscriptions renew unless canceled. You can cancel anytime.
            </Text>
          </View>

          <Text style={styles.faqHeader}>Frequently Asked Questions</Text>
          <FAQ q="Can I change my plan later?" a="Absolutely. You can upgrade or downgrade anytime; changes prorate on your next billing date." />
          <FAQ q="What happens during the free trial?" a="You get full access to the selected plan. We’ll notify you before the trial ends; you won’t be charged until you confirm." />
          <FAQ q="How do I cancel my subscription?" a="Go to Settings → Billing → Manage Subscription. Cancellation stops future renewals instantly." />
          <FAQ q="Are there any setup fees?" a="No. There are no setup or hidden fees." />
        </ScrollView>
      </SafeAreaView>
    </View>
  );
...
const styles = StyleSheet.create({
  ...
  segmented: { flexDirection: "row", backgroundColor: "rgba(255,255,255,0.35)", padding: 4, borderRadius: 999, marginBottom: 10 },
  ...
  card: {
    ...
    marginBottom: 20,
    position: "relative",
    ...Platform.select({ ios: { shadowColor: "#000", shadowOpacity: 0.15, shadowRadius: 12, shadowOffset: { width: 0, height: 4 } }, android: { elevation: 5 } }),
  },
  promoCard: { borderRadius: 16, borderWidth: 1, borderColor: "rgba(255,255,255,0.6)", backgroundColor: "rgba(255,255,255,0.55)", padding: 12, marginTop: 2 },
