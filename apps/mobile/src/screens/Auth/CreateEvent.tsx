    ...
    <LinearGradient colors={headerGradient} style={{ flex: 1 }}>
      <SafeAreaView style={{ flex: 1 }}>
        ...
        <ScrollView contentContainerStyle={{ padding: 16, paddingBottom: 120 }}>
          {step === 0 && (
            <Card title="🎉 Potluck Details" testID="event-details-card">
              {/* Title */}
              <Label testID="title-label">Event Title</Label>
              <Input placeholder="Enter title" value={title} onChangeText={setTitle} testID="event-title-input" />

              {/* Description */}
              <Label testID="description-label">Description (Optional)</Label>
              <Input 
              ...
              <View style={styles.row} testID="date-time-container">
                <View style={{ flex: 1, marginRight: 8 }}>
                  <Label testID="date-label">Date</Label>
                ...
                <View style={{ flex: 1, marginLeft: 8 }}>
                  <Label testID="time-label">Time</Label>
