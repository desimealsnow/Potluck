...
-- Use unique index instead of constraint (PostgreSQL limitation with functions)
CREATE UNIQUE INDEX IF NOT EXISTS item_catalog_name_cat_unit_uk 
...
-- Use unique index instead of constraint (PostgreSQL limitation with functions)
CREATE UNIQUE INDEX IF NOT EXISTS user_items_user_name_cat_unit_uk 
