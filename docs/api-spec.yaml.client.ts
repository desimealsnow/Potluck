...
const EventBase = z
  .object({
    ...
    capacity_total: z.number().int().gte(1).optional(),
    status: z
...
const Error = z
  ...
  .passthrough();
const postUserProfilephoneverify_Body = z
  .object({ phone_e164: z.string(), code: z.string() })
  .passthrough();
...
const ParticipantAdd = z
  .object({
    ...
    party_size: z.number().int().gte(1).optional().default(1),
    status: z
...
const Availability = z
  ...
  .passthrough();
const JoinRequestAdd = z
  .object({
    party_size: z.number().int().gte(1),
    note: z.string().max(500).optional(),
  })
  .passthrough();
const JoinRequestStatus = z.enum([
  "pending",
  "approved",
  "declined",
  "waitlisted",
...
const JoinRequest = JoinRequestAdd.and(
  z
    .object({
      id: z.string().uuid(),
      ...
      hold_expires_at: z.string().datetime({ offset: true }).optional(),
      created_at: z.string().datetime({ offset: true }),
      updated_at: z.string().datetime({ offset: true }).optional(),
    })
    .passthrough()
);
const PaginatedJoinRequests = z
  .object({
...
const ItemCatalog = z
  .object({
    ...
    default_per_guest_qty: z.number().optional(),
    dietary_tags: z.array(z.string()).optional(),
    description: z.string().optional(),
  })
  .passthrough();
const UserItemCreate = z
  .object({
    name: z.string(),
    category: z.string().optional(),
    unit: z.string().optional(),
    default_per_guest_qty: z.number().optional().default(1),
    dietary_tags: z.array(z.string()).optional(),
    notes: z.string().optional(),
  })
  .passthrough();
const UserItem = UserItemCreate.and(
  z.object({ id: z.string().uuid() }).passthrough()
);
const UserItemUpdate = UserItemCreate;
const ItemAssign = z
  .object({ user_id: z.string().uuid() })
  .partial()
  .passthrough();
const TransferParticipantRequest = z
  .object({
    new_user_id: z.string().uuid(),
    carry_items: z.boolean().optional().default(false),
  })
  .passthrough();
const TransferParticipantResponse = z
  .object({
    old_participant_id: z.string().uuid(),
...
const UserProfile = z
  .object({
    ...
    discoverability_radius_km: z.number().int(),
...
export const schemas = {
  ...
  EventWithItems,
  Error,
  postUserProfilephoneverify_Body,
  EventSummary,
...
`,
  ...
  },
  {
    ...
    alias: "getEventsEventIdavailability",
    requestFormat: "json",
    parameters: [
      {
        name: "eventId",
  ...
  {
    method: "post",
    path: "/events/:eventId/participants/:partId/transfer",
    alias: "postEventsEventIdparticipantsPartIdtransfer",
    requestFormat: "json",
    parameters: [
      {
        name: "body",
        type: "Body",
        schema: TransferParticipantRequest,
      },
      {
        name: "eventId",
        type: "Path",
    ...
    response: TransferParticipantResponse,
    errors: [
      {
        status: 401,
        description: `Access token missing or invalid`,
  ...
  {
    method: "post",
    path: "/events/:eventId/rebalance",
    alias: "postEventsEventIdrebalance",
    requestFormat: "json",
    parameters: [
      {
        name: "body",
        type: "Body",
        schema: z
          .object({ max_per_user: z.number().int().gte(1).default(2) })
          .partial()
          .passthrough()
          .optional(),
      },
    ...
    response: z.object({ assigned: z.number().int() }).passthrough(),
    errors: [
      {
        status: 401,
        description: `Access token missing or invalid`,
  ...
  },
  {
    ...
    alias: "postEventsEventIdrequests",
    requestFormat: "json",
    parameters: [
      {
        name: "body",
        type: "Body",
        schema: JoinRequestAdd,
      },
      {
        name: "eventId",
        type: "Path",
  ...
  },
  {
    method: "get",
    path: "/events/:eventId/requests",
    alias: "getEventsEventIdrequests",
    requestFormat: "json",
    parameters: [
      {
        name: "eventId",
    ...
    response: PaginatedJoinRequests,
    errors: [
      {
        status: 401,
        description: `Access token missing or invalid`,
  ...
  {
    method: "patch",
    path: "/events/:eventId/requests/:requestId/approve",
    alias: "patchEventsEventIdrequestsRequestIdapprove",
    requestFormat: "json",
    parameters: [
      {
        name: "eventId",
  ...
  {
    method: "patch",
    path: "/events/:eventId/requests/:requestId/cancel",
    alias: "patchEventsEventIdrequestsRequestIdcancel",
    requestFormat: "json",
    parameters: [
      {
        name: "eventId",
  ...
  {
    method: "patch",
    path: "/events/:eventId/requests/:requestId/decline",
    alias: "patchEventsEventIdrequestsRequestIddecline",
    requestFormat: "json",
    parameters: [
      {
        name: "eventId",
  ...
  {
    method: "post",
    path: "/events/:eventId/requests/:requestId/extend",
    alias: "postEventsEventIdrequestsRequestIdextend",
    requestFormat: "json",
    parameters: [
      {
        name: "eventId",
  ...
  {
    method: "patch",
    path: "/events/:eventId/requests/:requestId/reorder",
    alias: "patchEventsEventIdrequestsRequestIdreorder",
    requestFormat: "json",
    parameters: [
      {
        name: "body",
        type: "Body",
        schema: z.object({ waitlist_pos: z.number() }).passthrough(),
      },
      {
        name: "eventId",
        type: "Path",
  ...
  {
    method: "patch",
    path: "/events/:eventId/requests/:requestId/waitlist",
    alias: "patchEventsEventIdrequestsRequestIdwaitlist",
    requestFormat: "json",
    parameters: [
      {
        name: "eventId",
  ...
  {
    method: "post",
    path: "/events/:eventId/requests/promote",
    alias: "postEventsEventIdrequestspromote",
    requestFormat: "json",
    parameters: [
      {
        name: "eventId",
    ...
    response: z.object({ moved: z.number().int() }).partial().passthrough(),
    errors: [
      {
        status: 401,
        description: `Access token missing or invalid`,
  ...
  },
  {
    ...
    alias: "postUserProfilephonesend",
    requestFormat: "json",
    parameters: [
      {
        name: "body",
        type: "Body",
        schema: z.object({ phone_e164: z.string() }).passthrough(),
      },
    ],
    response: z.void(),
    errors: [
  ...
  },
  {
    ...
    alias: "postUserProfilephoneverify",
    requestFormat: "json",
    parameters: [
      {
        name: "body",
        type: "Body",
        schema: postUserProfilephoneverify_Body,
      },
    ],
    response: z.void(),
    errors: [
  ...
  },
  {
    method: "get",
    path: "/user-profile/phone/verify",
    alias: "getUserProfilephoneverify",
